...
class IndexObject:
    ...
    def merge_with(self, index2: 'IndexObject'):
        """
...
class IndexStore:
    ...
    def tf_doc_of_object(self, word: str) :
        """
    ...
    def fetch_word_tf(self, word: str) :
        """
    ...
    def add_word(self, doc: str, word: str):
        """
    ...
    def compute_bm25(self, k1: float, b: float):
        """
    ...
    def compute_ranked_retrieval(self, query: str) :
        """
    ...
    def compute_ranked_retrieval_as_list(self, query: str) :
        """
